...
const CreateTeamProfile = ({
  ...
  useEffect(() => {
    ...
    const channel = supabase.channel('team-profile-updates').on('postgres_changes', {
      event: 'UPDATE',
      schema: 'public',
      table: 'team_profiles',
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 space-y-6">
          ...
          <div className="text-left space-y-3">
            ...
            <div className="relative">
              ...
              <Input type="url" placeholder="https://your-team-website.com" value={websiteUrl} onChange={e => setWebsiteUrl(e.target.value)} className="pl-12 py-6 bg-accent/10 border-accent/30 text-gray-700 placeholder:text-gray-500" />
            </div>
          </div>
